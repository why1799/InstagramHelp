...
import {NonMutualSubscriptions} from "./NonMutualSubscriptions";

function ShowChosenTab(props) {
    if(props.nonMutualSubscriptions)
    {
        return <NonMutualSubscriptions/>
    }
    else
    {
        return <div/>
...
export class Home extends Component {
  ...
  chosenClass = 'T-jvg';
    ...
    async fetchUserData() {
        ...
        document.title = data.fullName + " (@" + data.userName + ")";
    }
        ...
        return (
            <main className="SCxLW  o64aR flex_column" role="main">
                <div className="v9tJq AAaSh flex_column">
                    ...
                    <ShowChosenTab nonMutualSubscriptions={this.state.nonMutualSubscriptions}/>
                </div>
            </main>
        );
    }
